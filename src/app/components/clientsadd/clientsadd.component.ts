...
export class ClientsaddComponent implements OnInit {
  ...
  createForm(){
    this.form = this.formbuilder.group({
      clientName:['', Validators.compose([Validators.required,Validators.minLength(5),this.validateLetters])],
      clientAddress:['', Validators.compose([Validators.required,Validators.maxLength(50),Validators.minLength(8),])],
      clientContact:['', Validators.compose([Validators.required,Validators.maxLength(11),Validators.minLength(11),this.validateContact])],
      clientEmail:['', Validators.compose([Validators.maxLength(100),this.validateEmail])]
